...
import 'package:admin_panel_appointzz/Views/Home/DoctorBookings/Booking%20Details/BookingDetails.dart';
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(context,
                CupertinoPageRoute(builder: (context) => const BookingDetails()));
          },
          child: Container(

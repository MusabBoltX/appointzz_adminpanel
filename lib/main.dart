import 'package:admin_panel_appointzz/Services/Internet.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'Views/LogReg/LogReg.dart';

void main() {
  runApp(const AppointzzAdminPanel());
}

class AppointzzAdminPanel extends StatelessWidget {
  const AppointzzAdminPanel({Key? key}) : super(key: key);
